...
import WebpartReact from './components/WebpartReact';
import { IWebpartReactProps } from './components/IWebpartReactProps';
...
export default class WebpartReactWebPart extends BaseClientSideWebPart<IWebpartReactWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IWebpartReactProps> = React.createElement(
      WebpartReact,
      {
